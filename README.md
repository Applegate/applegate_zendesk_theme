# Applegate Zendesk Theme

This is the Applegate theme for Zendesk. This theme was forked from the Copenhagen theme that is the default Zendesk Guide theme. It is designed to be responsive and accessible.
